      ...
      >
        ...
        <div className="card-nav-top absolute inset-x-0 top-0 h-[60px] flex items-center justify-between p-2 pl-[1.1rem] z-[2]">
          <div
            ...
            tabIndex={0}
            style={{ color: menuColor || "#1c1917" }}
          >
            <div
              className={`w-[22px] h-[2px] bg-current transition-[transform,opacity] duration-300 ease-linear origin-center ${
          ...
          <div className="flex items-center md:absolute md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 order-1 md:order-none">
            <span className="font-serif text-xl font-bold text-[#c2410c] tracking-tight">
              ClarionGuard
            </span>
          </div>
          ...
          <a
            href={buttonHref}
            className="hidden md:inline-flex border-0 rounded-[calc(0.75rem-0.2rem)] px-4 items-center h-[calc(100%-0.5rem)] font-medium cursor-pointer transition-colors duration-200 text-sm"
